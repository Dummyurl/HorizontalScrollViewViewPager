...
public class ViewPagerInRecyclerViewHeaderActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pager_in_recycler_view_header2);
        initView();
        initData();
    }
    ...
    private static class MyAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_HEADER) {
                View headerView = LayoutInflater.from(mContext).inflate(R.layout.viewpager_layout2, null);
        ...
        private void bindHeaderViewHolder(HeaderViewHolder holder) {
            ...
            CircleIndicatorViewPager viewPager = holder.viewPager;
